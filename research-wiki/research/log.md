...
### 本轮完成
- 第6章哲学：基于 IMA 原书 PDF 逐段比对重写，按原文自身逻辑分三层（描述决定解释 / 叙事的陷阱 / 实用主义与投资），曼德勃罗关键句独立引用块突出章旨，修复多处脱离原文的表述
- 第7章文学：同样逐段比对，三层结构（为什么阅读 / 如何阅读 / 读什么），补回"阅读作为修正装置"过渡段
- 新建 wiki 页：[[articles/concepts/艾德勒-四级阅读法]]，含四个阅读层次 × 四个基本问题 × 批判性阅读分析师报告 × 与格栅理论衔接
- 更新 index.md
