# -*- coding: utf-8 -*-
"""阜丰集团 00546 — VL Business + AI Commentary（数据驱动, 自动生成）"""
def build(stock, metrics, revenue_structure, years, cagr, spot):
    ...
    # Business
    biz=f"阜丰集团是全球最大的味精和黄原胶生产商，主营玉米生化产品，包括味精、谷氨酸、黄原胶、苏氨酸等食品添加剂和动物营养产品。FY2025营收279亿元，归母净利25亿元。" + f"营收{_fmt(rev,0)}亿（同比{_dir(rev,py.get("OPERATE_INCOME"))}{r_abs:.1f}%），业务结构：食品添加剂48%、动物营养38%、高档氨基酸7%、胶体4%。"
