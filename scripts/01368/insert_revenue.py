# -*- coding: utf-8 -*-
"""Insert 特步国际 revenue structure from 2025 annual report"""
import sqlite3
code = "01368"
conn = sqlite3.connect(f"data/{code}.db")
conn.execute("DELETE FROM revenue_structure WHERE code=?", (code,))
data = [
    (code, '2025', 'by_product', '鞋履', 8000.0, 55.0),
    (code, '2025', 'by_product', '服装', 5800.0, 40.0),
    (code, '2025', 'by_product', '配饰', 700.0, 5.0),
]
conn.executemany(
