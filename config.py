...
STOCKS = {
    ...
    "02400": {
        ...
        "industry": "Technology",
        "fiscal_yr_end": "12-31",
        "business_desc": "心动公司是中国领先的游戏开发商和游戏社区平台运营商，核心业务包括：①游戏运营（自研+代理），代表作品《出发吧麦芬》《铃兰之剑》《火炬之光：无限》《仙境传说RO》等，覆盖MMORPG、Roguelike、放置类等多元品类；②TapTap平台——中国最大的手游社区与分发平台之一，以\"不联运、不分成\"的独特模式吸引开发者，通过广告和技术服务变现。2025年营收约43亿元，TapTap中国MAU超4,000万，海外版加速扩张。",
        "analyst": {
            "commentary": [
                "心动公司2025年营收约43亿元（+25%），扭亏为盈，non-IFRS净利润约8.5亿元。游戏业务：《出发吧麦芬》国内+海外双线爆发，成为年度最大增量；《铃兰之剑》海外上线贡献增量；《火炬之光：无限》长线运营稳定。TapTap：广告系统算法升级推动eCPM提升，平台收入增长30%+，信息服务毛利率超80%。",
                "每股收益¥1.70中，主业经营贡献¥1.55（91%），投资及其他贡献¥0.15（9%）。每股经营现金流¥2.20，资本支出¥0.40/股（研发+服务器），净留存¥1.80/股。公司从2022-2023年的大规模研发投入期进入收获期——游戏 pipeline 逐步兑现，TapTap 平台效应增强，经营杠杆开始显现。",
                "毛利率58%、净利率20%（non-IFRS）、ROE 13%。心动公司的护城河是\"游戏+平台\"双轮飞轮：优质独占游戏 → 为TapTap导流 → 社区活跃度提升 → 更多开发者入驻 → 更多独占内容。这个飞轮在《出发吧麦芬》爆款后明显加速。TapTap\"不联运\"模式对中小开发者极具吸引力，构成了区别于华为/OPPO/Vivo应用商店的差异化壁垒。风险：游戏产品生命周期波动、版号政策、买量成本上升。",
                "当前PE约9倍（non-IFRS约7x），估值处于历史低位，主要受港股流动性折价及市场对游戏公司估值偏见影响。公司账面净现金约20亿元，占总市值约25%，安全边际充足。核心逻辑：①《出发吧麦芬》生命周期超预期（放置类长尾特性）；② TapTap广告加载率从3%→5%的提价空间；③ 海外市场（东南亚+欧美）从0到1的增量。若利润持续兑现，PE有望从9x向15-20x重估。",
                "AI对心动存在双重机会：①AI辅助游戏开发降本——美术/剧情/关卡设计效率提升30%+，研发费用率有望从25%降至20%；②TapTap的AI推荐算法提升广告匹配效率，直接增厚信息服务收入。关注TapTap海外版用户增速和AI相关功能落地进度。"
            ],
        },
    },
    "000786": {
