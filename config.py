...
STOCKS = {
    ...
    "600519": {
        ...
        "fiscal_yr_end": "12-31",
        "business_desc": "贵州茅台是中国高端白酒绝对龙头，核心产品飞天茅台占据2000+元价格带垄断地位。公司拥有不可复制的地理护城河（茅台镇独特微生物环境）、深厚的品牌壁垒（国酒地位）及稀缺产能。营收结构以茅台酒为主（~85%），系列酒（茅台1935等）为辅（~15%），毛利率长期维持91%+，净利率50%+，ROE 30%+。渠道改革（i茅台直销占比提升至45%+）持续释放利润。年产基酒约5.7万吨，产能天花板约7-8万吨。",
        "analyst": {
            "commentary": [
                "贵州茅台2025年营收约1,741亿元（+15.7%），扣非净利润约862亿元（+15.3%）。茅台酒营收1,459亿（+15.2%），系列酒营收247亿（+19.8%），i茅台直销平台贡献约312亿（占总营收18%）。飞天茅台出厂价1169元/瓶，终端批价约2700元，渠道利润丰厚，提价空间充足。",
                "每股收益¥68.59中，主业贡献¥62.32（91%），非经营性收益¥6.27（9%）。每股现金流¥74.12，资本支出¥8.50（产能扩建），现金分红¥35.00/股（支付率51%），净留存¥30.62/股。现金流极度充裕，分红率持续提升。茅台酒基酒产量5.72万吨，系列酒基酒4.81万吨，3-5年后可售商品酒将显著放量。",
                "毛利率91.5%（连续15年>90%）、净利率49.5%、ROE 34.2%——茅台是全球盈利能力最强的消费品公司之一。竞争壁垒：①不可复制的茅台镇7.5平方公里核心产区微生物环境；②53度飞天茅台占据消费者心智的国酒地位；③社会库存（渠道+消费者囤积）形成天然需求缓冲。风险：宏观经济下行压制高端消费、产能扩张后稀缺性稀释、白酒消费人口结构变化。",
                "当前PE约22.5倍，低于5年历史中位数（约35x），处于历史区间的低位区。PB约7.5倍，ROE 34%支撑高PB溢价。股息率约2.2%，支付率51%仍有提升空间（账上现金超2,000亿）。估值已从2021年PE 70x泡沫回归理性，当前约等于无风险利率倒数隐含的合理PE。关注批价走势——若飞天批价跌破2500元则需重新评估渠道健康度。",
            ],
        },
    },
    "002014": {
    ...
    "00883": {
        ...
        "analyst": {
            "commentary": [
                "油价周期+高股息，CNOOC估值修复空间如何？",
                "2026年6月1日 — 中国海洋石油2025年实现营收约4,409亿元，扣非净利润约1,350亿元，基本EPS约2.85港元。油价中枢维持在70-80美元/桶区间，公司净利润保持高位。桶油成本持续下降，竞争优势明显。",
                "公司产量持续增长，2025年净产量突破2亿桶油当量。勘探成功率保持行业领先，海外资产（尼日利亚、巴西、圭亚那等）贡献占比提升。贸易业务（中海油国际贸易）体量稳定。资本支出控制在收入的40%以内，自由现金流充裕。",
                "当前TTM PE约9-10倍，处于历史中位数偏低水平。PB约1.5倍。公司承诺2025-2027年分红率不低于45%，2025年股息率约6-7%，在港股高股息板块中极具吸引力。关注油价走势及OPEC+产量政策——核心估值驱动变量。"
            ],
        },
    },
    "01368": {
    ...
    "000408": {
        ...
        "industry": "Metals & Mining",
        "fiscal_yr_end": "12-31",
        "business_desc": "藏格矿业是中国领先的钾肥和铜矿生产企业，主营氯化钾、碳酸锂及铜矿的开采、生产和销售。公司拥有青海察尔汗盐湖钾肥资源和西藏巨龙铜矿等核心资产，是国内钾肥行业重要参与者。",
    },
    "601225": {
        "name": "陕西煤业",
    ...
    "02097": {
        ...
        "industry": "Consumer",
        "fiscal_yr_end": "12-31",
        "business_desc": "蜜雪集团是中国最大的现制茶饮企业，全球门店超4万家（截至2025年），主营冰淇淋、柠檬水和茶饮产品。核心商业模式为加盟——公司向加盟商销售原材料、设备及收取加盟服务费，轻资产、高现金流。定位极致性价比（2-8元价格带），下沉市场渗透率极高。2025年3月港交所上市，海外门店（东南亚为主）超4,000家，是中国门店数量最多的餐饮品牌。",
        "analyst": {
            "commentary": [
                "蜜雪集团2025年营收约302亿元（+29.5%），扣非净利润约48亿元（+40.2%）。商品销售（向加盟商销售原材料）占比约95%，加盟费及服务收入约5%。全球门店突破4.1万家（+25%），其中海外门店4,000+家。单店日均销售额稳中有升，同店增速约+4%-6%。净利润率16.1%，在餐饮加盟赛道中处于领先水平。",
                "每股收益¥1.27中，主业经营贡献¥1.20（94%），利润高度纯粹。每股现金流¥1.52，资本支出¥0.18（轻资产模式扩张成本极低），现金分红¥0.38（支付率30%），净留存¥0.96/股。现金流充裕，加盟模式先收钱后发货，营运资金为负但属于竞争优势。",
                "毛利率38.2%、净利率16.1%、ROE 42.5%——加盟模型下轻资产高回报的典范。竞争壁垒：①规模效应——4万+门店的供应链网络摊薄采购和物流成本，形成成本优势护城河；②品牌心智——\"高质平价\"定位深入人心，消费者认知难以被竞争对手替代；③加盟商生态——单店投资回收期12-18个月，加盟商粘性高。风险：食品安全事件、加盟商管理边界、海外扩张不确定性、下沉市场竞争加剧（甜啦啦、古茗等）。",
                "当前PE约22倍，PB约6.5倍。ROE 42.5%支撑溢价，PEG（PE/增长率）约0.6x显示估值合理偏低。2025年上市首年表现低于预期，市场担忧增速见顶和加盟模式天花板。关注2026年海外门店扩张节奏、单店营收趋势及第二增长曲线（瓶装饮料、咖啡等新品类）——这是估值能否从22x向30x重估的核心驱动力。",
            ],
        },
    },
    "605499": {
    ...
    "300308": {
        ...
        "analyst": {
            "commentary": [
                "中际旭创：AI算力核心受益者，800G/1.6T光模块全球领先",
                "2026年6月 — 中际旭创是全球AI算力产业链最核心的A股标的之一。公司占据全球高速光模块市场份额第一（约30%），深度绑定北美四大云厂商。AI大模型训练对800G/1.6T光模块需求呈指数级增长，公司作为英伟达GPU配套光模块主力供应商持续受益。",
                "2025年营收约410亿元（+75%），归母净利润约96亿元（+120%）。800G出货量全球第一，1.6T已进入量产阶段。毛利率约35%，净利率约23%，ROE约28%。AI驱动的高速光模块营收占比超85%。",
                "竞争壁垒：①先发优势——全球最早量产800G光模块，1.6T领先竞品6-12个月；②客户粘性——深度参与北美云厂商光模块设计验证，切换成本极高；③规模效应——产能全球最大，单位成本持续下降。风险：AI资本开支周期性、光模块价格年降压力、中美贸易限制。",
                "当前PE约20-25x（TTM），处于历史中位数偏低水平。PEG约0.5x显示高增长被低估。关注每季度800G/1.6T出货量及北美云厂商Capex指引作为核心验证信号。",
            ],
        },
    },
    "NVDA": {
