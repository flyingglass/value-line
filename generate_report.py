...
(function(){{
  ...
  html+='<div style="font-size:8px;line-height:1.4">';
  ...
  html+='<table style="width:100%;border-collapse:collapse;font-size:7.5px;line-height:1.35;margin:1px 0">';
  ...
  setTimeout(function(){{
    ...
    echarts.init(document.getElementById('chart_volume')).setOption({{
      grid:{{left:0,right:28,top:0,bottom:0}},
      xAxis:{{type:'category',data:dates,show:false,boundaryGap:false}},
      yAxis:{{type:'value',axisLabel:{{fontSize:8,color:'#000',formatter:function(v){{return v+'%';}}}},splitLine:{{show:false}},position:'right'}},
