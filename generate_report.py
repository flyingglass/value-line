...
(function(){{
  ...
  html+='<div style="font-size:10px;font-weight:700">'+commentary[0]+'</div>';
  html+='<p style="text-align:justify;margin-top:2px">'+commentary[1]+'</p>';
  html+='<p style="text-align:justify">'+commentary[2]+'</p>';
  html+='<p style="text-align:justify">'+commentary[3]+'</p>';
  html+='<p style="text-align:right;font-size:8px;color:#666;margin-top:4px">Analyst\u2019s Commentary \u2014 300\u2013400 word report on recent developments and prospects \u2014 issued every three months on a regular schedule.</p>';
  html+='</div>';
