...
(function(){{
  ...
  html+='<div>* Diluted EPS, excl. estimate data</div>';
  html+='<div>&dagger; Declared dividends, AKShare sourced</div>';
  html+='<div>&Dagger; Vs. '+indexName+'; VL: vs. ~1,700 stocks universe</div>';
  html+='<div>All figs. in CNY (¥) unless noted.</div>';
  html+='</div>';
