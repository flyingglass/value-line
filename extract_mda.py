...
def classify_sentences(sentences):
    """打分分类: 每句归入得分最高的类别 (通用关键词, 支持权重元组)"""
    categories = {
        "overview": [("经营", 1.0), ("市场地位", 1.0), ("本集团", 0.8),
                     ("业务", 0.5), ("公司", 0.5)],
        ...
        "outlook":  [("展望未來", 5.0), ("未來展望", 5.0), ("業務展望", 5.0),
                     ("前景展望", 5.0), ("展望", 3.0),
                     ("未来", 1.0), ("战略", 1.0), ("布局", 1.0),
                     ("目标", 1.0), ("计划", 1.0), ("方向", 1.0), ("愿景", 1.0), ("使命", 1.0)],
    }
